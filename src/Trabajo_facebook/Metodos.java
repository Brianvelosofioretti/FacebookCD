...
FacebookFactory ff = new FacebookFactory(cb.build());
 facebook = ff.getInstance(); 
    ...
    /**
     * post a message using a  @param mensaje
     */
...
/**
 * Search theme on time line using a @param grupo 
 */
...
/**
 * Publish a comment passing as a @param comentario 
 */
